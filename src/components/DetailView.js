                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={styles.actionButtonContainerRoot}>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'white'} style={{backgroundColor: '#c64c38'}} icon="phone" mode="contained" onPress={() => console.log('Pressed')}>
                                Call
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'white'} style={{backgroundColor: '#c64c38'}} icon="email" mode="contained" onPress={() => console.log('Pressed')}>
                                E-mail
                            </Button>
                        </View>
                        <View style={styles.actionButtonContainer}>
                            <Button color={'white'} style={{backgroundColor: '#c64c38'}} icon="message-alert" mode="contained" onPress={() => console.log('Pressed')}>
                                SMS
                            </Button>
                        </View>
                    </View>
